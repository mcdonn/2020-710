...
Follow the steps provided on these websites in this order: 
  ...
  2. Download Virtual Box for OS X [here](https://www.virtualbox.org/wiki/Downloads).[^1] Follow all instructions closely [here](https://web.archive.org/web/20160819084623/https://linus.nci.nih.gov/bdge/installUbuntu.html), all the way to the bottom of the page.
...
[^1]: Apparently, Virtual Box can be very slow at first but improves after you restart your computer several times. 
