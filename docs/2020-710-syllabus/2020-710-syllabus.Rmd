...
The course readings listed in the [course schedule](#course-schedule) can be accessed through Google Drive unless they are already available online. The folder [2020-710](https://drive.google.com/drive/folders/16VKMCJfY4upj8EiKUjbLk-pFXxL7upXZ?usp=sharing) will be shared with the class during the first week of classes.
...
## Grading
  ...
  * Students are required to be at every class and participate in class discussions of the readings. When readings are assigned, students are required to send two short comments or questions on [Laulima](https://laulima.hawaii.edu/x/2m30JN) about the reading by **8pm the day before the reading is to be discussed**.
...
3. Presentations with handout  [**20%** ]{style="float:right"}
...
5. Documentation enrichment project [**25%** ]{style="float:right"}
...
<!-- INSERT PRESENTATION TOPICS HERE -->
...
1. FINISH AUDIO/VIDEO RECORDING BEFORE INDONESIA
2. WHILE IN INDONESIA: LEAH AND CHRISTINA TEACH ELAN(?)
3. BACK FROM INDONESIA: MINI PRESENTATIONS / TRANSCRIPTION 
...
**Week 3 (1/28): Archiving \& metadata** 
  ...
  * **Assignments:** [CITI certificate training](https://www.hawaii.edu/researchcompliance/get-training-0) Click on the link and follow the steps. Under step 6, follow instructions for ***"Non-Exempt Social or Behavioral Sciences Research"***.
...
**Week 5 (2/11): (away) Video Recording**
...
**Week 6 (2/18): (away) Video conversion**
    
  * **Readings:** [ELAR video conversion handout](https://www.soas.ac.uk/elar/helpsheets/file120820.pdf)
  * **Assignment:** Group video recording assignment
    
**Week 7 (2/25): (away) ELAN**
  
  * **Readings:** @berez2007review, 
  * **Assignment:** Combining audio and video recording assignment ELAN Assignment
  * **Additional readings:**
    
**Week 8 (3/3): ELAN**

  * **Readings:** @schultze-berndt2006linguistic
  * **Assignment:**
  * **Additional readings:**

**Week 9 (3/10): FLEx**

  * **Readings:** [Online training modules](https://vimeo.com/channels/fieldworks)
  * **Assignment:** FLEx assignment
  * **Additional readings:**    

**SPRING BREAK (3/17): NO CLASS**

**Week 10 (3/24): FLEx-ELAN**

  * **Readings:** @bow2003general, [Leipzig Glossing Rules](http://www.eva.mpg.de/lingua/resources/glossing-rules.php), [Working with ELAN and FLEx together](https://www.soas.ac.uk/elar/helpsheets/file122785.pdf)
  * **Assignment:** ELAN FLEx import export assignment
  * **Additional readings:**

**Week 11 (3/31): FLEx-ELAN**

  * **Readings:** [Working with ELAN and FLEx together (Handout #1)](https://www.soas.ac.uk/elar/helpsheets/file122785.pdf), [Working with ELAN and FLEx together (Handout #2)](https://www.soas.ac.uk/elar/helpsheets/file122785.pdf)
  * **Assignment:**
  * **Additional readings:**
...
**Week 12 (4/7): Transcription (Level 1)**
  ...
  * **Assignment:** Transcribe two minutes of conversation up to level 1. Be ready to share/discuss excerpt!
  * **Additional readings:**

**Week 13 (4/14): Transcription (Level 2)**

  * **Readings:** @dubois1992discourse [: ch. 11-12], Du Bois handouts (Vocal Noises, Quality)
  * **Assignment:** Enrich two minutes of conversation up to level 2. Be ready to share/discuss excerpt!
...
**Week 14 (4/21): Transcription (Level 3)**
  ...
  * **Assignment:** Enrich two minutes of conversation up to level 3 and upload to Google Drive.  
  * **Additional readings:**
...
**Week 15 (4/28): Searching in ELAN & FLEx**

  * **Readings:** Searching an ELAN corpus (no readings)
  * **Assignment:**
  * **Additional readings:**
